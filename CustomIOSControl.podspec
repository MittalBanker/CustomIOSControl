#
#  Be sure to run `pod spec lint CustomIOSControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "Custom IOS Controls which can be customized in Interface builder"

  s.homepage     = "https://github.com/miralmegha/CustomIOSControl"
  ...
  s.author             = { "Mittal" => "mit.banker1@gmail.com" }
  # Or just: s.author    = "Mittal"
  # s.authors            = { "Mittal" => "mit.banker1@gmail.com" }
  # s.social_media_url   = "https://twitter.com/mittal_iMobile"
